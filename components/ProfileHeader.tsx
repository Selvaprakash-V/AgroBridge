  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-3">
      <div className="container mx-auto max-w-7xl">
        <div className="bg-white/30 backdrop-blur-2xl shadow-lg rounded-3xl border border-white/40 px-4 md:px-6 py-4 md:py-5 transform transition-all" style={{ background: 'linear-gradient(135deg, rgba(34,197,94,0.12) 0%, rgba(16,185,129,0.08) 60%)' }}>
